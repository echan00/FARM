...
ner_labels = ['[PAD]','X','N','Y','[SEP]','[CLS]']
processor = NER2Processor(
    tokenizer=tokenizer, max_seq_len=384, data_dir="./", metric="seq_f1", label_list=ner_labels
)
...
model = AdaptiveModel(
    ...
    lm_output_types=["per_token_additional_features"],
    device=device,
)
...
save_dir = "saved_models/bert-tagatag"
model.save(save_dir)
